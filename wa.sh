...
echo $red "100% • • • • • • • • • •"
sleep 2
echo $green "SUKSES SLURR :v !"
sleep 2
echo $red "Data :"
echo
echo  $green "Nomor kamu $nama"
echo $green "Nomor target $cewek"
sleep 1
echo $green "Silahkan tunggu 10-15 menit"
echo $green "Untuk mendapatkan kode verifikasi ilegal"
echo $green "FiqiSans & FiqiXcode7 In Here"
fi

if [ $Gans = 2 ] || [ $Gans = 02 ]
then
git clone https://github.com/Fiqi-WibuSoft/Sadap-WhatsApp
echo
cd prank
php wa.php
fi
...
echo $red "Loading..."
sleep 1
echo $blue "+6281455119351"
sleep 1
echo $green "+6285745151698"
sleep 1
echo $cyan "+6281250274632"
sleep 1
echo $purple "+6285704868189"
sleep 1
echo $blue "+6282133059248"
sleep 1
echo $red "+6282292789020"
sleep 1
echo $green "+6282138152597"
sleep 1
echo $cyan "+6281217809109"
sleep 1
...
if [ $Gans = 0 ] || [ $Gans = 00 ]
then
echo  $red "Jangan lupakan nama saya FiqiXcode7"
echo  $blue "Admin dari Indonesia Hack Team!"
echo  $green "Sampai jumpa ! JANGAN LUPA FOLLOW INSTAGRAM @hyputganz_ :v"
exit
fi
